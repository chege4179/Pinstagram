 ...
 */
package com.peterchege.pinstagram.feature.feature_search.presentation.domain.use_case
...
class SearchUseCase @Inject constructor(
    ...
    operator fun invoke(username:String): Flow<Resource<SearchUserResponse>> = flow {
